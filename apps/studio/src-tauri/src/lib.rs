...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            harness_cmds::harness_permission_pending,
            harness_cmds::harness_permission_decide,
            harness_cmds::harness_permission_set_mode,
            harness_cmds::harness_agent_spawn,
            harness_cmds::harness_agent_list,
            harness_cmds::harness_agent_stop,
            harness_cmds::harness_agent_remove,
